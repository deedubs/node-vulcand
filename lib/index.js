...
/**
 * Get servers on the proxy for a specific backend
 *
 * @param  {Object}   options
 * @param  {String}   options.backend  Backend to read servers from
 * @param  {Function} cb
 */
Vulcan.prototype.getServers = function(options, cb) {
